...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		setCustomTabView(R.layout.item_sub_tab, R.id.sub_tab_textview);
	}
	...
	private View getTabView(int tabIndex) {
		...
		return mTabStrip.getChildAt(tabIndex);
	}
	...
	public void setNewCountForTab(int count, int tabIndex) {
		...
		if (tabView != null) {
			TextView countTextView = (TextView) tabView
					.findViewById(R.id.sub_tab_number_icon);
			ImageView smallNewMark = (ImageView) tabView
					.findViewById(R.id.sub_tab_new_icon);
	...
	public void setTitleForTab(String title, int tabIndex) {
		View tabView = getTabView(tabIndex);
