...
/**
 */
public class MeetingCheckInActivity extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        name = intent.getStringExtra("EXTRA_TITLE");
        ...
        progressDialog = new ProgressDialog(MeetingCheckInActivity.this);
        ...
        if (mAdapter == null) {
            Toast.makeText(this, R.string.nfc_nomodule, Toast.LENGTH_SHORT).show();
    ...
    public void onNewIntent(Intent intent) {
        if (start) {
            ...
            if (null != cardPhyId) {
                ...
                //System.out.println("++++++++EXTRA_MID++++" + mid);
                String url_query = "http://202.118.89.129/dlmu_rest_webservice/CI0101?mid=" + mid + "&token=1&cardphyid=" + cardPhyId;
                ...
                try {
                    ...
                    if (data.getInt("muflag") == 0) {
                        String save = new saveLogTask().execute(url_save, mid, data.getString("muuserid"), data.getString("muusername"), data.getString("mudeptcode"), data.getString("mudeptname"), App.readUser().getUsername()).get();
