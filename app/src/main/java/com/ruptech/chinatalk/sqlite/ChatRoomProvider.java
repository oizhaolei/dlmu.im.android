...
public class ChatRoomProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.ruptech.dlmu.im.provider.ChatRoom";
	public static final String TABLE_ROSTER = ChatRoomTable.getName();
	public static final String QUERY_URI = "chatroom";
	...
	public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.yaxim.chatroom";
	public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.yaxim.chatroom";
	...
	static {
		URI_MATCHER.addURI(AUTHORITY, "chatroom", CONTACTS);
		URI_MATCHER.addURI(AUTHORITY, "chatroom/#", CONTACT_ID);
...
//                break;
		...
		if (ret == null) {
			infoLog("ChatRoomProvider.query: failed");
		} else {
