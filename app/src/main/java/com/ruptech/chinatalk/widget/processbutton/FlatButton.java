...
public class FlatButton extends Button {
	...
	private Drawable createNormalDrawable(TypedArray attr) {
		GradientDrawable drawableNormal = (GradientDrawable) getDrawable(
				R.drawable.rect_btn).mutate();

		drawableNormal.setCornerRadius(getCornerRadius());

		int normal = getColor(R.color.orange_highlight);
		int colorPressed = attr.getColor(R.styleable.FlatButton_pb_colorNormal,
				normal);
		drawableNormal.setColor(colorPressed);
    ...
    private Drawable createPressedDrawable(TypedArray attr) {
        GradientDrawable drawablePressed =
                (GradientDrawable) getDrawable(R.drawable.rect_btn).mutate();
        drawablePressed.setCornerRadius(getCornerRadius());

		int blueDark = getColor(R.color.add_friend_pressed);
